    ...
    <div className='min-w-0' style={{ background: 'var(--seo-bg)' }}>
      ...
      >
        ...
        <div className='relative max-w-[1200px] mx-auto px-4 text-center'>
          ...
          >
            9 нейросетей для создания изображений — от фотореализма до арта. Без
            VPN, с оплатой в рублях.
          </p>
          <Link
            to={cta}
            ...
            {models.map((m) => (
              ...
              >
                ...
                <p
                  ...
                  style={{ fontSize: 14, color: 'var(--seo-text)' }}
                >
                  {m.desc}
                </p>
                <span
      ...
      <ScenariosGrid
        ...
        items={[
          {
            title: 'Фотореалистичные портреты',
            description: 'Фотосессии без фотографа',
          },
          {
            title: 'Арт и иллюстрации',
            description: 'Уникальный арт в любом стиле',
          },
          {
            title: 'Логотипы и брендинг',
            description: 'Дизайн логотипов за минуту',
          },
          {
            title: 'Контент для соцсетей',
            description: 'Картинки для постов и Stories',
          },
        ]}
      />
            ...
            <table className='w-full' style={{ fontSize: 14 }}>
              <thead>
                <tr style={{ background: 'var(--seo-table-header)' }}>
                  {['Модель', 'Цена, cr', 'Скорость', 'Качество', 'Стиль'].map(
                    (h) => (
                      <th
                        key={h}
              ...
              <tbody>
                {tableRows.map((r, i) => (
                  <tr
                    ...
                    style={{
                      background:
                        i % 2 === 1 ? 'var(--seo-table-alt)' : 'transparent',
                    }}
                  >
                    <td
                      style={{
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            {benefits.map((b) => (
              ...
              >
                ...
                <p style={{ fontSize: 14, color: 'var(--seo-text)' }}>
                  {b.desc}
                </p>
              </div>
            ))}
        ...
        <div className='max-w-[800px] mx-auto px-4'>
          ...
          {faqData.map((item, i) => (
            <div
              key={i}
              style={{
                borderBottom: '1px solid var(--seo-faq-border)',
                padding: '20px 0',
              }}
            >
              <button
      ...
      <section style={{ padding: '80px 0' }}>
        <div className='max-w-[1200px] mx-auto px-4'>
          ...
          >
            ...
            <p
              className='mb-8'
              style={{ fontSize: 16, color: 'var(--seo-text)' }}
            >
