...
const voices = [
  ...
  },
  {
    ...
    lang: 'Русский',
    color: '#ff7a3d',
    category: ['popular', 'female', 'russian'],
  },
  {
    name: 'Elena V',
    gender: 'Женский',
...
const welcomeScenarios: WelcomeScenario[] = [
  ...
  },
  {
    ...
    prompt:
      'Энергичный поп-трек для рекламы, позитивное настроение, запоминающийся припев, современное звучание',
    providerId: 'suno',
  },
  {
    Icon: Headphones,
  ...
  },
  {
    ...
    prompt:
      'Короткий запоминающийся джингл для бренда, 15 секунд, оптимистичный, с вокальным хуком',
    providerId: 'suno',
  },
  {
    Icon: Languages,
    ...
    prompt:
      'Hello everyone! Welcome to our new product presentation. Today we will show you something truly amazing.',
    providerId: 'elevenlabs',
  },
  {
    Icon: AudioLines,
    ...
    desc: 'Генерация SFX',
    prompt:
      'Атмосферный эмбиент для медитации, мягкие волны, пение птиц, лёгкий ветер',
    providerId: 'suno',
  },
];
...
const AudioPage = () => {
  ...
  const [selectedModel, setSelectedModel] = useState<'elevenlabs' | 'suno'>(
    'elevenlabs',
  );
      ...
      () => {
        setGenerations((prev) => [
          ...prev,
          {
            ...
            audioDuration: isEL
              ? '0:18'
              : sunoDuration === 'До 1 минуты'
                ? '0:58'
                : sunoDuration === 'До 2 минут'
                  ? '1:54'
                  : '3:42',
          },
        ]);
        ...
        <div className='flex-1 overflow-y-auto w-full'>
                    ...
                    {[
                      {
                        ...
                        name: 'ElevenLabs',
                        desc: 'Озвучка и голос',
                        credits: 60,
                      },
                      {
                        id: 'suno' as const,
                        name: 'Suno',
                        desc: 'Генерация музыки',
                        credits: 30,
                      },
                    ].map((m) => (
                      <button
          ...
          {!hasGenerations ? (
            ...
            <>
              ...
              {isGenerating && (
                <GenerationLoader type='audio' model={currentSubName} />
              )}
              <div ref={feedEndRef} />
            </>
          )}
          ...
          <div className='px-4 lg:px-8 py-6 space-y-8 border-t border-border mt-4'>
              ...
              <>
                    ...
                    {filteredVoices.map((v) => (
                      ...
                      >
                        ...
                        >
                          <Play
                            size={8}
                            className='ml-px text-muted-foreground'
                          />
                        </div>
                      </button>
                    ))}
                ...
                <div className='flex flex-col sm:flex-row gap-4'>
                  {[
                    ...
                    >
                      <div className='text-[13px] text-muted-foreground uppercase tracking-wide mb-3'>
                        {s.title}
                      </div>
                      <PillDropdown
                        value={s.value}
                        options={s.options.map((o) => ({ value: o, label: o }))}
                        onSelect={(v) => s.setter(v)}
                      />
                    </div>
                  ))}
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                  {[
                    ...
                    },
                    {
                      ...
                      value: sunoMode,
                      setter: setSunoMode,
                      options: ['Автоматический', 'Инструментал', 'Свой текст'],
                    },
                    {
                      title: 'ДЛИТЕЛЬНОСТЬ',
                      value: sunoDuration,
                      setter: setSunoDuration,
                      options: ['До 1 минуты', 'До 2 минут', 'До 4 минут'],
                    },
                  ].map((s) => (
                    <div
                      key={s.title}
            ...
            {/* ─── Models block (shared) ─── */}
            <div>
              <h2 className='text-lg font-bold text-foreground mt-10 mb-5'>
                Модели
              </h2>
                ...
                {[
                  {
                    id: 'elevenlabs' as const,
                    name: 'ElevenLabs',
                    desc: 'Озвучка текста и клонирование голоса',
                    credits: 60,
                  },
                  {
                    id: 'suno' as const,
                    name: 'Suno',
                    desc: 'Генерация музыки по описанию',
                    credits: 30,
                  },
                ].map((m) => (
                  <button
