    ...
    <div className='min-w-0' style={{ background: 'var(--seo-bg)' }}>
      ...
      >
        ...
        <div className='relative max-w-[1200px] mx-auto px-4 text-center'>
          ...
          >
            6 провайдеров, 15+ моделей для работы с текстом. Единая подписка без
            ...
            {models.map((m) => (
              ...
              >
                ...
                <div className='flex items-center gap-2 mb-2'>
                  ...
                  {m.provider && (
                    <span
                      style={{ fontSize: 12, color: 'var(--seo-text-muted)' }}
                    >
                      ({m.provider})
                    </span>
                  )}
        ...
        items={[
          {
            ...
            description: 'Блоги, лендинги, описания товаров',
          },
          {
            title: 'Код и разработка',
            description: 'Написание, отладка и рефакторинг кода',
          },
          {
            title: 'Аналитика и отчёты',
            description: 'Обработка данных и построение выводов',
          },
          {
            title: 'Переводы',
            description: 'Профессиональный перевод на 50+ языков',
          },
        ]}
      />
