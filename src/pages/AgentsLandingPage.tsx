...
const agents: { Icon: LucideIcon; name: string; description: string }[] = [
  ...
  },
  {
    ...
    description:
      'Анализирует таблицы, строит отчёты, находит инсайты в данных.',
  },
  {
    Icon: Globe,
    name: 'Переводчик',
    description:
      'Переводит тексты с сохранением стиля и контекста. 50+ языков.',
  },
  {
    Icon: FileText,
    name: 'Редактор',
    description:
      'Проверяет грамматику, улучшает стиль, адаптирует тексты под целевую аудиторию.',
  },
  {
    Icon: Smartphone,
    name: 'SMM-менеджер',
    description:
      'Создаёт контент-планы, пишет посты, придумывает идеи для Reels и Stories.',
  },
  {
    Icon: Mail,
...
const benefits: { Icon: LucideIcon; title: string; description: string }[] = [
  {
    ...
    title: 'Готовые роли',
    description:
      'Не нужно писать промпт с нуля. Каждый агент уже настроен под свою задачу.',
  },
  {
    Icon: RefreshCw,
    title: 'Любая модель',
    description:
      'Агенты работают на ChatGPT, Claude, Gemini — выбирайте лучшую для задачи.',
  },
  {
    Icon: Zap,
    title: 'Мгновенный старт',
    description:
      'Выберите агента и начните работу. Без регистрации, без настройки.',
  },
];
    ...
    <div className='min-h-screen' style={{ background: 'var(--seo-bg)' }}>
      ...
      >
        <div className='max-w-[1200px] mx-auto text-center'>
          ...
          >
            Готовые ИИ-ассистенты для бизнеса и творчества. Настроенные промпты,
            специализированные роли — начните работу за секунду.
          </p>
          <Link
            to={cta}
        ...
        items={[
          {
            ...
            description: 'Посты, рассылки, статьи за минуты',
          },
          {
            title: 'Бизнес-аналитика',
            description: 'Отчёты, стратегии, конкурентный анализ',
          },
