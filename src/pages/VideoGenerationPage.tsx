...
const models = [
  ...
  },
  {
    name: 'Vidu AI',
    badge: 'NEW',
    desc: 'Новая модель с поддержкой длинных видео.',
    credits: 40,
  },
];
    ...
    <div className='min-w-0' style={{ background: 'var(--seo-bg)' }}>
      ...
      >
        ...
        <div className='relative max-w-[1200px] mx-auto px-4 text-center'>
          ...
          >
            7 нейросетей для создания видео — от коротких клипов до
            кинематографичных сцен. Без VPN, с оплатой в рублях.
          </p>
          <Link
            to={cta}
        ...
        items={[
          {
            ...
            description: 'Продающие видео для бизнеса и соцсетей',
          },
          {
            title: 'Музыкальные клипы',
            description: 'Визуальный ряд под любой трек',
          },
          {
            title: 'Анимация персонажей',
            description: 'Оживление статичных изображений',
          },
          {
