...
const designScenarios = [
  {
    name: 'Фотореалистичный портрет',
    gradient: 'linear-gradient(135deg, #1a0533, #2d1250)',
  },
  {
    name: 'Арт и иллюстрация',
...
const welcomeScenarios: WelcomeScenario[] = [
  ...
  },
  {
    ...
    prompt:
      'Minimal flat vector logo design, clean lines, modern typography, white background, professional branding',
    providerId: 'flux',
  ...
  },
  {
    ...
    prompt:
      'Anime style character illustration, vibrant colors, detailed eyes, dynamic pose, studio ghibli inspired',
    providerId: 'midjourney',
    subModelId: 'niji-7',
    aspect: '3:4',
    quality: '2K',
  ...
  },
  {
    ...
    prompt:
      'Eye-catching social media post design, bold typography, gradient background, modern aesthetic, Instagram ready',
...
const DesignPage = () => {
  ...
  const handleGenerate = () => {
    ...
    const imgs = Array.from({ length: Math.max(1, quantity) }, () => ({
      width: w,
      height: h,
    }));
  ...
  return (
    <ErrorBoundary>
      <div className='flex flex-col h-[calc(100vh-var(--header-height,64px))] mesh-background'>
        ...
        <div className='flex-1 overflow-y-auto w-full relative z-[1]'>
          ...
          {!hasGenerations ? (
            <WelcomeBlock
              ...
              onScenarioClick={(scenario) => {
                ...
                if (scenario.providerId) {
                  const prov = imageProviders.find(
            ...
            <>
              ...
              {isGenerating && (
                <GenerationLoader type='image' model={subModel?.name} />
              )}
              <div ref={feedEndRef} />
            </>
          )}
          ...
          {!hasGenerations && (
            <div className='px-4 lg:px-8 py-6 space-y-6 border-t border-border mt-6'>
              ...
              />
              <ScenariosCarousel
                title='Сценарии для изображений'
        ...
        <div
          className={cn(
            'shrink-0 px-4 lg:px-6 pb-4 pt-1.5 bg-[var(--bg-primary)] relative z-[1]',
          )}
        >
