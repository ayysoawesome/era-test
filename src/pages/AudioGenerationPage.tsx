...
const useCases: { Icon: LucideIcon; title: string; description: string }[] = [
  ...
  },
  {
    ...
    title: 'Реклама',
    description:
      'Аудиоролики для рекламы. Естественный голос без найма диктора.',
  },
  {
    Icon: Music,
    title: 'Музыка',
    description:
      'Создание уникальных треков для контента, подкастов, видео и презентаций.',
  },
  {
    Icon: Languages,
    title: 'Локализация',
    description:
      'Перевод и озвучка контента на другие языки с сохранением интонации.',
  },
];
...
const benefits: { Icon: LucideIcon; title: string; description: string }[] = [
  {
    Icon: Globe,
    title: 'Без VPN',
    description: 'ElevenLabs и Suno работают напрямую из России.',
  },
  {
    Icon: CreditCard,
    ...
    <div className='min-h-screen' style={{ background: 'var(--seo-bg)' }}>
      ...
      >
        <div className='max-w-[1200px] mx-auto text-center'>
          ...
          >
            Озвучка, музыка, клонирование голоса — 2 мощные нейросети в одном
            месте. Без VPN, с оплатой в рублях.
          </p>
          <Link
            to={cta}
      ...
      <ScenariosGrid
        ...
        items={[
          {
            title: 'Озвучка видео',
            description: 'Профессиональный голос для роликов',
          },
          { title: 'Рекламные аудио', description: 'Ролики без найма диктора' },
          {
            title: 'Музыкальные треки',
            description: 'Уникальная музыка для контента',
          },
          {
            title: 'Локализация',
            description: 'Перевод голоса на другие языки',
          },
        ]}
      />
