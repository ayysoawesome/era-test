    ...
    <div className='min-w-0'>
      ...
      <section className='relative overflow-hidden'>
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 100% at 50% 0%, rgba(232,84,32,0.12) 0%, rgba(255,122,61,0.04) 40%, transparent 70%)',
          }}
        />
        <motion.div
          className='relative max-w-4xl mx-auto text-center px-4 pt-16 pb-10 md:pt-20'
          initial='hidden'
          animate='show'
          variants={stagger}
        >
          <motion.p
            variants={fadeUp}
            className='text-xs uppercase tracking-[2px] text-primary font-semibold mb-4'
          >
            Тарифы
          </motion.p>
          <motion.h1
            variants={fadeUp}
            className='text-[32px] md:text-[44px] font-bold mb-4'
          >
          ...
          <motion.div
            variants={fadeUp}
            className='inline-flex rounded-full border border-[hsl(var(--border))] p-1'
          >
            <button
            ...
            >
              Год
              <span className='font-mono tabular-nums text-[10px] bg-white/20 px-1.5 py-0.5 rounded-full font-bold'>
                −18%
              </span>
            </button>
            <button
      ...
      <section className='max-w-7xl mx-auto px-4 pb-8'>
            ...
            return (
              ...
              >
                ...
                <div className='mb-2 min-h-[20px]'>
                  {plan.oldPrice && (
                    <span className='font-mono tabular-nums text-sm text-muted-foreground line-through mr-2'>
                      {plan.oldPrice}
                    </span>
                  )}
                </div>
        ...
        <div className='text-center mt-12'>
          <p className='text-muted-foreground text-sm'>
            Оплата через ЮKassa · Карты РФ · СБП · Рассрочка
          </p>
          <p className='text-muted-foreground text-xs mt-2'>
            Отмена подписки в любой момент · Возврат в течение 3 дней
          </p>
        </div>
      </section>
      ...
      <section className='max-w-4xl mx-auto px-4 pb-16'>
        ...
        >
          ...
          <p className='text-sm md:text-base text-muted-foreground max-w-xl mx-auto mb-6 leading-relaxed'>
            За каждого друга, который зарегистрируется по вашей ссылке, вы оба
            получите по 100 бесплатных кредитов. Без ограничений на количество
            приглашений.
          </p>
